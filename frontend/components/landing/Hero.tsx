...
const Hero = () => {
  ...
  return (
    <section
      className="relative pt-32 pb-20 overflow-hidden min-h-[90vh] flex flex-col items-center justify-center border-b border-white/10"
    >
      {/* Background Grids */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        >
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-accents-4 leading-[1.1] max-w-5xl mx-auto drop-shadow-2xl">
        ...
        <motion.p
          ...
          className="text-lg font-medium tracking-wide mb-8 bg-clip-text text-transparent bg-gradient-to-r from-gray-200 to-gray-600"
        >
          If you want to contribute to this cause and earn, run a worker node.
        </motion.p>
